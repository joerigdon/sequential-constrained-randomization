...
##Read in simulated data and make figure
##30 simulation settings (ICC 0, 0.05, 0.1) x (nb 6, 12) x (B 3, 6, 12, 18, 24)
...
##Get tables of differences in adjusted and unadjusted estimates, with bootstrap 95% CIs
